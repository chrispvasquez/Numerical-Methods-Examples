...
Show(mySum, 10.0);   //Calculate and Output the functional values for given equation for n = 10
Show(mySum, 50.0);   //Calculate and Output the functional values for given equation for n = 50
Show(mySum, 100.0);  //Calculate and Output the functional values for given equation for n = 100
Show(mySum, 500.0);  //Calculate and Output the functional values for given equation for n = 500
Show(mySum, 1000.0); //Calculate and Output the functional values for given equation for n = 1000
Show(mySum, 5000.0); //Calculate and Output the functional values for given equation for n = 5000
